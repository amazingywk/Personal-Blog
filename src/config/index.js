...
const config = {
  ...
  FAIL: 0,    //接口返回的失败的状态
  NOTICE: '热烈庆祝社区正式开始了开发，更多精彩的页面及功能敬请期待。',//首页滚动通知栏内容
  ...
  PERSONALAUTHORITY:[
    {text:'个人主页',name:'user/own'},
    {text:'消息',name:'message/manage'},
    {text:'注销',name:'logout'},
  ],                                                  // 右侧头像弹出框内容
  USERAUTHORITY:[
    {text:'主页',name:'home'},
    {text:'赞助作者',name:'sponsor'},
    {text:'关于',name:'about'},
  ],                                                 // 左侧菜单弹出框内容
  MANAGERAUTHORITY:[
    {text:'主页',name:'home'},
    {text:'用户管理',name:'user/manage'},
    {text:'分类管理',name:'classification'},
    {text:'文章审核',name:'article/manage'},
    {text:'赞助作者',name:'sponsor'},
    {text:'关于',name:'about'},
  ],
  ARTICLEAUTHORITY:[
